...
class SubaddressingDialogBuilder {
  ...
  OnCopyButtonAction? _onCopyButtonAction;

  SubaddressingDialogBuilder(
    this._imagePath,
    {
  ...
  void subaddress(String subaddress) {
  ...
  void onCopyButtonAction(OnCopyButtonAction? onCopyButtonAction) {
    _onCopyButtonAction = onCopyButtonAction;
  }
